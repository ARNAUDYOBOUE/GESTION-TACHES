...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\HP\\Desktop\\gestion-taches\\prisma\\generated\\client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "C:\\Users\\HP\\Desktop\\gestion-taches\\prisma\\schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
  ...
  "inlineSchema": "datasource db {\n  provider = \"mysql\"\n  url      = env(\"DATABASE_URL\") // Utilise la variable d'environnement DATABASE_URL\n}\n\ngenerator client {\n  provider = \"prisma-client-js\"\n  output   = \"./generated/client\" // Spécifie un chemin de sortie personnalisé\n}\n\nmodel User {\n  id        Int      @id @default(autoincrement())\n  email     String   @unique\n  password  String\n  createdAt DateTime @default(now())\n}\n",
  "inlineSchemaHash": "b8a3d088e5c415c36b28854feb3d8eac9f31d8953a24626183bbd1eef3ee8f72",
  "copyEngine": true
}
